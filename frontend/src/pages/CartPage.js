    ...
    return (
        <Row>
            <Col md={8}>
              ...
              <Message>Your cart is empty <Link to='/'>Home</Link>
                  ...
                  {cartItems.map(item => (
                      ...
                      <ListGroupItem key={item.product}>
                          <Row>
                              ...
                              <Col md={2}>
                                  <Button type="button" variant="red" onClick={() => removeFromCartHandler(item.product)}>
                                      <i className="fas fa-trash-alt color"></i>
                                  </Button>
                              </Col>
                          </Row>
                      </ListGroupItem>
            ...
            <Card>
                <ListGroup variant="flush">
                    <ListGroupItem>
                     ...
                     <ListGroupItem>
                     <h2>Price: ${cartItems.reduce((acc, item) => acc + item.quantity * item.price, 0).toFixed(2)}</h2>
                     </ListGroupItem>
